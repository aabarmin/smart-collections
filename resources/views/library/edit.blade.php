...
<div class="container">
    <form method="POST" action="/library/{{ $vinyl->vinyl_id }}">
        ...
        <div class="row row-cols-1 row-cols-xs-1 row-cols-md-2">
            <div class="col">
                ...
                <div class="form-floating mb-3">
                    <input name="vinyl_title" type="text" class="form-control" id="album-title" value="{{ $vinyl->vinyl_title }}">
                    <label for="album-title">Album Title</label>
                </div>

                <div class="form-floating mb-3">
                    <input name="vinyl_artist" type="text" class="form-control" id="album-artist" value="{{ $vinyl->vinyl_artist }}">
            ...
            <div class="col">
                ...
                <div class="container">
                    <div class="row row-cols-2 image-container">
                        ...
                        <input type="hidden" name="vinyl_images[{{ $loop->index }}][image_path]" value="{{ $vinyl_image->image_path }}" />
                        @endforeach
                    </div>
                </div>
        ...
        <div class="row row-cols-1 row-cols-xs-1 row-cols-md-2">
            ...
            <div class="col">
                <div class="form-floating mb-3">
                    <input name="vinyl_sides[{{ $vinyl_side->side_id }}][side_title]" type="text" class="form-control" id="side-{{ $vinyl_side->side_id }}-title" value="{{ $vinyl_side->side_title }}" />
                ...
                <div class="tracks-container" id="tracks-container-{{ $vinyl_side->side_id }}">
                    ...
                    <div class="form-floating mb-3 track-container input-group" id="side-{{ $vinyl_side->side_id }}-track-{{ $loop->index }}-container" data-track-id="{{ $loop->index }}">
                        <input name="vinyl_sides[{{ $vinyl_side->side_id }}][side_tracks][{{ $loop->index }}][track_title]" type="text" class="form-control" id="side-{{ $vinyl_side->side_id }}-track-{{ $loop->index }}" value="{{ $vinyl_track->track_title }}" />
                        <button type="button" data-side-id="{{ $vinyl_side->side_id }}" data-track-id="{{ $loop->index }}" class="remove-track-button btn btn-outline-secondary">
                            X
                        </button>
                ...
                <div class="d-grid gap-2">
                    <button type="button" data-side-id="{{ $vinyl_side->side_id }}" class="btn-lg btn btn-primary add-track-button">Add track</button>
                </div>
